...
<div class="moduk-do-dont-list">
  <h3 class="moduk-do-dont-list__label">Do</h3>
  <ul class="moduk-list moduk-list--tick">
    <li>
      <svg class="moduk-icon moduk-icon__tick" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" aria-hidden="true" width="34" height="34">
...
<div class="moduk-do-dont-list">
  ...
  <ul class="moduk-list moduk-list--cross">
    <li>
      <svg class="moduk-icon moduk-icon__cross" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" aria-hidden="true" width="34" height="34">
