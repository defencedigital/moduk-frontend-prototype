...
Find out more about the table component and when to use it in the [Defence Service Manual](#0).

## Quick start examples

### Simple table

[Preview the table component](https://defencedigital.github.io/moduk-frontend/components/tables/index.html)
...
[Preview the table panel component](https://defencedigital.github.io/moduk-frontend/components/tables/tables-panel.html)
...
[Preview the responsive table component](https://defencedigital.github.io/moduk-frontend/components/tables/responsive-table.html)
...
| **panel**              | boolean    | No        | If set to true, the table is rendered inside a [panel with a label](https://defencedigital.github.io/moduk-frontend/components/panel-with-label.html). |
