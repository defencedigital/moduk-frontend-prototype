...
[Preview the action link component](https://nhsuk.github.io/moduk-frontend/components/action-link/index.html)

### HTML markup

```html
<div class="moduk-action-link">
  <a class="moduk-action-link__link" href="https://www.nhs.uk/service-search/minor-injuries-unit/locationsearch/551">
    ...
    <span class="moduk-action-link__text">Find a minor injuries unit</span>
  </a>
</div>
```
