...
const syncAllConditionalReveals = function syncAllConditionalReveals(input) {
  ...
  allInputsInForm.forEach((item) => toggleConditionalInput(item, 'moduk-checkboxes__conditional--hidden'));
};
...
export default () => {
  ...
  const checkboxInputs = document.querySelectorAll('.moduk-checkboxes .moduk-checkboxes__input');
  ...
  */
  const handleClick = (event) => {
    ...
    toggleConditionalInput(event.target, 'moduk-checkboxes__conditional--hidden');
