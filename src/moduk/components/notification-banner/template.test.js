...
describe('Notification-banner', () => {
  describe('default example', () => {
    ...
    it('aria-labelledby attribute matches the title id', () => {
      const $ = render('notification-banner', examples.default)
      const ariaAttr = $('.moduk-notification-banner').attr('aria-labelledby')
      const titleId = $('.moduk-notification-banner__title').attr('id')
    ...
    it('has role=region attribute', () => {
      const $ = render('notification-banner', examples.default)
      const $component = $('.moduk-notification-banner')
    ...
    it('has data-module attribute to initialise JavaScript', () => {
      ...
      expect($component.attr('data-module')).toEqual('moduk-notification-banner')
    })

    it('renders header container', () => {
      const $ = render('notification-banner', examples.default)
      const $header = $('.moduk-notification-banner__header')
    ...
    it('renders default heading level', () => {
      const $ = render('notification-banner', examples.default)
      const $title = $('.moduk-notification-banner__title')
    ...
    it('renders content', () => {
      const $ = render('notification-banner', examples.default)
      const $content = $('.moduk-notification-banner__heading')
  ...
  describe('html', () => {
    ...
    it('renders nested components using `call`', () => {
      ...
      expect($('.moduk-notification-banner .app-nested-component').length).toBeTruthy()
    })
    ...
    it('renders content as escaped html when passed as text', () => {
      ...
      const $content = $('.moduk-notification-banner__content')

      expect($content.html().trim()).toEqual('<p class="moduk-notification-banner__heading">&lt;span&gt;This publication was withdrawn on 7 March 2014.&lt;/span&gt;</p>')
    })

    it('renders content as html', () => {
      const $ = render('notification-banner', examples['with text as html'])
      const $contentHtml = $('.moduk-notification-banner__content')

      expect($contentHtml.html().trim()).toEqual('<h3 class="moduk-notification-banner__heading">This publication was withdrawn on 7 March 2014</h3><p class="moduk-body">Archived and replaced by the <a href="#" class="moduk-notification-banner__link">new planning guidance</a> launched 6 March 2014 on an external website</p>')
    })
  })
  ...
  describe('when success type is passed', () => {
    it('renders with appropriate class', () => {
      ...
      const $component = $('.moduk-notification-banner')
      expect($component.hasClass('moduk-notification-banner--success')).toBeTruthy()
    })
    ...
    it('does render aria-labelledby', () => {
      ...
      expect($component.attr('aria-labelledby')).toEqual('moduk-notification-banner-title')
    })

    it('renders a title id for aria-labelledby', () => {
      const $ = render('notification-banner', examples['with type as success'])
      const $component = $('.moduk-notification-banner__title')

      expect($component.attr('id')).toEqual('moduk-notification-banner-title')
    })
