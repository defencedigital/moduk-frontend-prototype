...
describe('Input', () => {
  ...
  describe('custom options', () => {
    ...
    it('doesn\'t render the input wrapper', () => {
      ...
      const $wrapper = $('.moduk-form-group > .moduk-input__wrapper')
  ...
  describe('when it includes an error message', () => {
    ...
    it('includes the error class on the input', () => {
      ...
      const $component = $('.moduk-input')
      expect($component.hasClass('moduk-input--error')).toBeTruthy()
    })
  ...
  describe('with dependant components', () => {
    it('have correct nesting order', () => {
      ...
      const $component = $('.moduk-form-group > .moduk-input')
  ...
  describe('when it includes a prefix', () => {
    ...
    it('renders the prefix inside the wrapper', () => {
      ...
      const $prefix = $('.moduk-form-group > .moduk-input__wrapper > .moduk-input__prefix')
  ...
  describe('when it includes a suffix', () => {
    ...
    it('renders the suffix inside the wrapper', () => {
      ...
      const $suffix = $('.moduk-form-group > .moduk-input__wrapper > .moduk-input__suffix')
  ...
  describe('when it includes both a prefix and a suffix', () => {
    it('renders the prefix before the suffix', () => {
      ...
      const $prefixBeforeSuffix = $('.moduk-form-group > .moduk-input__wrapper > .moduk-input__prefix ~ .moduk-input__suffix')
