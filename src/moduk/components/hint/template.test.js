...
describe('Hint', () => {
  describe('by default', () => {
    ...
    it('allows text to be passed whilst escaping HTML entities', () => {
      ...
      const content = $('.moduk-hint').html().trim()
    ...
    it('allows HTML to be passed un-escaped', () => {
      ...
      const content = $('.moduk-hint').html().trim()
      expect(content).toEqual('It&apos;s on your National Insurance card, benefit letter, payslip or <a class="moduk-link" href="#">P60</a>.\nFor example, &apos;QQ 12 34 56 C&apos;.')
    })
