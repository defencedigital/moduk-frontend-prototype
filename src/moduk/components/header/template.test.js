...
describe('header', () => {
  ...
  describe('custom options', () => {
    ...
    it('renders custom container classes', () => {
      ...
      const $component = $('.moduk-header')
      const $container = $component.find('.moduk-header__container')

      expect($container.hasClass('moduk-header__container--full-width')).toBeTruthy()
    })
    ...
    it('renders custom navigation classes', () => {
      ...
      const $component = $('.moduk-header')
      const $container = $component.find('.moduk-header__navigation')

      expect($container.hasClass('moduk-header__navigation--end')).toBeTruthy()
    })
    ...
    it('renders home page URL', () => {
      ...
      const $component = $('.moduk-header')
      const $homepageLink = $component.find('.moduk-header__link--homepage')
  ...
  describe('with product name', () => {
    it('renders product name', () => {
      ...
      const $component = $('.moduk-header')
      const $productName = $component.find('.moduk-header__product-name')
  ...
  describe('with service name', () => {
    it('renders service name', () => {
      ...
      const $component = $('.moduk-header')
      const $serviceName = $component.find('.moduk-header__service-name')
  ...
  describe('with navigation', () => {
    ...
    it('renders navigation', () => {
      ...
      const $component = $('.moduk-header')
      const $list = $component.find('ul.moduk-header__navigation-list')
      const $items = $list.find('li.moduk-header__navigation-item')
      const $firstItem = $items.find('a.moduk-header__link:first-child')
    ...
    it('renders navigation label and menu button text when these are both set', () => {
      ...
      const $component = $('.moduk-header')
      const $nav = $component.find('nav')
      const $button = $component.find('.moduk-header__menu-button')
    ...
    it('renders navigation with active item', () => {
      ...
      const $activeItem = $('li.moduk-header__navigation-item:first-child')
      expect($activeItem.hasClass('moduk-header__navigation-item--active')).toBeTruthy()
    })
    ...
    it('allows navigation item text to be passed whilst escaping HTML entities', () => {
      ...
      const $navigationLink = $('.moduk-header__navigation-item a')
    ...
    it('renders navigation item with text without a link', () => {
      ...
      const $navigationItem = $('.moduk-header__navigation-item')
    ...
    describe('menu button', () => {
      it('has an explicit type="button" so it does not act as a submit button', () => {
        ...
        const $button = $('.moduk-header__menu-button')
  ...
  describe('SVG logo', () => {
    const $ = render('header', examples.default)
    const $svg = $('.moduk-header__logotype-crown')
    ...
    describe('fallback PNG', () => {
      const $fallbackImage = $('.moduk-header__logotype-crown-fallback-image')
