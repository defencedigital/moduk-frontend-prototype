...
describe('Inset text', () => {
  describe('by default', () => {
    ...
    it('renders with classes', () => {
      ...
      const $component = $('.moduk-inset-text')
    ...
    it('renders nested components using `call`', () => {
      ...
      expect($('.moduk-inset-text .app-nested-component').length).toBeTruthy()
    })

    it('allows text to be passed whilst escaping HTML entities', () => {
      const $ = render('inset-text', examples['html as text'])

      const content = $('.moduk-inset-text').html().trim()
    ...
    it('allows HTML to be passed un-escaped', () => {
      ...
      const mainContent = $('.moduk-inset-text .moduk-body:first-child').text().trim()
      const warningContent = $('.moduk-inset-text .moduk-warning-text__text').text().trim()
