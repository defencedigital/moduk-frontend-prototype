...
describe('Error-summary', () => {
  describe('default example', () => {
    ...
    it('has a child container with the role=alert attribute', () => {
      const $ = render('error-summary', examples.default)
      const childRoleAttr = $('.moduk-error-summary div:first-child').attr('role')
    ...
    it('renders title text', () => {
      const $ = render('error-summary', examples.default)
      const summaryTitle = $('.moduk-error-summary__title').text().trim()
    ...
    it('number of error items matches the number of items specified', () => {
      const $ = render('error-summary', examples.default)
      const errorList = $('.moduk-error-summary .moduk-error-summary__list li')
    ...
    it('error list item is an anchor tag if href attribute is specified', () => {
      ...
      const errorItem = $('.moduk-error-summary .moduk-error-summary__list li:first-child')
    ...
    it('render anchor tag href attribute is correctly', () => {
      ...
      const errorItem = $('.moduk-error-summary .moduk-error-summary__list li:first-child a')
  ...
  describe('custom options', () => {
    it('allows title text to be passed whilst escaping HTML entities', () => {
      ...
      const summaryTitle = $('.moduk-error-summary__title').html().trim()
    ...
    it('renders description text', () => {
      ...
      const summaryDescription = $('.moduk-error-summary__body p').text().trim()
    ...
    it('allows description text to be passed whilst escaping HTML entities', () => {
      ...
      const summaryDescription = $('.moduk-error-summary__body p').html().trim()
    ...
    it('renders anchor tag with attributes', () => {
      ...
      const $component = $('.moduk-error-summary__list a')
    ...
    it('renders error item text', () => {
      ...
      const errorItemText = $('.moduk-error-summary .moduk-error-summary__list li:first-child').text().trim()
    ...
    it('allows error item HTML to be passed un-escaped', () => {
      ...
      const errorItemText = $('.moduk-error-summary .moduk-error-summary__list li').html().trim()
    ...
    it('allows error item HTML inside "a" tag to be passed un-escaped', () => {
      ...
      const errorItemText = $('.moduk-error-summary .moduk-error-summary__list li a').html().trim()
