...
describe('Label', () => {
  describe('by default', () => {
    ...
    it('renders label text', () => {
      const $ = render('label', examples.default)
      const labelText = $('.moduk-label').text().trim()
    ...
    it('allows label text to be passed whilst escaping HTML entities', () => {
      ...
      const labelText = $('.moduk-label').html().trim()
    ...
    it('renders for attribute if specified', () => {
      ...
      const labelForAttr = $('.moduk-label').attr('for')
