...
function Tabs ($module) {
  ...
  this.jsHiddenClass = 'moduk-tabs__panel--hidden'
}
...
Tabs.prototype.onTabClick = function (e) {
  if (!e.target.classList.contains('moduk-tabs__tab')) {
...
Tabs.prototype.unhighlightTab = function ($tab) {
  $tab.setAttribute('aria-selected', 'false')
  $tab.parentNode.classList.remove('moduk-tabs__list-item--selected')
  $tab.setAttribute('tabindex', '-1')
}

Tabs.prototype.highlightTab = function ($tab) {
  $tab.setAttribute('aria-selected', 'true')
  $tab.parentNode.classList.add('moduk-tabs__list-item--selected')
