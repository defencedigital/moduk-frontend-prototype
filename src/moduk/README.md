...
`.moduk-!-font-width-regular`.

If a class only overrides when a condition is met, the condition will be at the end of the class name. For example `.moduk-!-display-none-print` will only override with `display: none` in a print layout.
